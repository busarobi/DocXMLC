...
\usepackage[nonatbib]{nips2018_style/nips_2018}
...
%viz., sparse, dense and tree-ensemble representations.
The experimental results are presented in
Section~\ref{sec:empirical_results}. 
Finally we make concluding remarks. % and discuss future directions.
...
These issue has been recently considered in~\citep{Jernite_et_al_2017}. %However, in  are based  
...
%As discussed in Section~\ref{sec:regret}, PLTs are consistent in estimation of marginal probabilities and for maximization of precision@$k$ in the multi-label setting. Below, we show that they get exactly the same model as \Algo{HSM} in case of a multi-class distribution. 
...
% only. It can be easily extended to return the top $k$ labels as in case of \Algo{PLT}. 
...
%We tested two widely used document representation approaches for PLT: TF-IDF vectors which is used in XMLC repository~\footnote{Manik's repo}, and word embeddings~\cite{Mikolov_et_al_2013}. Note that, using TF-IDF, the document representation vector is sparse, whereas word embeddings results in dense vectors with typically less than 1000 dimension.
...
% %
% In our implementation, we update the word embeddings by using %ensemble of PLTs as well as single PLT by averaging the gradients
...
\vspace{-.1cm}
        ...
        \begin{center}
                \begin{small}
                        %\vspace{-0.1cm}
                        \begin{tabular}{l@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r} %@{\hskip 4pt} r@{\hskip 4pt} r}
                                \toprule
...
Wiki30K & 29815 & 106605 & 12959 & 5992 \\%& 8.30 & 18.74 \\
Amazon12K & 12277 & 173192 & 490310 & 152981 \\%& 214.45 & 5.37 \\
Delicious200K & 205443 & 782585 & 100095 & 196606 \\%& 72.29 & 75.54\\
WikiLSHTC325K & 325056 & 1617899 & 587084 & 1778351 \\% &17.46 &3.19\\
%Delicious-200K & 670091 & 173194 & 490449 & 153025 & 4.01 & 5.45 \\
%WikiLSHTC-325K & 670091 & 173194 & 490449 & 153025 & 4.01 & 5.45 \\
...
%\begin{table}[b]
%\vspace{-.2cm}
%        \caption{Precision@$k$ with $k=\{ 1,3,5\}$ of \Algo{HSM} and \Algo{PLT}s. }
%        \label{tab:hsm_vs_plt}
%        \begin{center}
%                \begin{tiny}
%                        \vspace{-0.1cm}
%						\begin{adjustbox}{width=1\linewidth}
%                        \begin{tabular}{l | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} }
...
%	Yahoo! & \data{68.40}{57.56}{45.84} & \databf{72.09}{61.17}{48.49} & \data{67.80}{54.88}{43.78} & \databf{71.79}{58.82}{46.38} \\ \midrule
%	RCV1 & \data{87.73}{69.98}{50.17} & \databf{90.47}{72.54}{51.84} & \data{93.94}{76.75}{53.61} & \databf{95.41}{77.49}{53.91} \\ \midrule
%	Wiki30k & \data{70.20}{60.11}{53.17} & \databf{84.34}{72.34}{62.72} & \data{83.02}{69.66}{59.50} & \databf{85.11}{73.12}{62.67} \\ \midrule
%	Amazon12k & \data{86.69}{72.00}{57.97} & \databf{91.46}{76.00}{61.40} & \data{90.18}{72.53}{56.20} & \databf{92.98}{75.75}{59.53} \\ \midrule
%	EUR-Lex & \data{56.98}{46.99}{39.09} & \databf{74.55}{60.60}{50.05} & \data{66.39}{54.05}{44.73} & \databf{73.19}{57.79}{46.98} \\ \midrule
%	Delicious200K & \data{41.58}{33.24}{28.04} & \databf{45.27}{38.95}{35.59} & \data{42.17}{37.94}{35.77} & \databf{46.98}{40.99}{38.04} \\ \midrule
%	WikiLSHTC325K & \data{36.90}{22.30}{16.60} & \databf{41.63}{26.78}{20.39} & \data{41.28}{24.68}{18.08} & \databf{41.78}{24.96}{18.53} \\ \midrule
%        Amazon670K & \data{33.64}{28.58}{25.01} & \databf{36.85}{32.48}{29.15} & \data{25.04}{21.06}{18.28} & \databf{26.18}{22.76}{20.29} \\
%								\bottomrule
%                        \end{tabular}
%						\end{adjustbox}
%                \end{tiny}
...
\vspace{-.2cm}
        ...
        \begin{center}
                \begin{footnotesize}
                        \vspace{-0.1cm}
						%\begin{adjustbox}{width=1\linewidth}
                        \begin{tabular}{l | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | l | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} }
                       % \begin{tabular}{@{}r@{~}r@{~|~}r@{~|~}r@{}r@{}}
                                \toprule
	& \multicolumn{2}{|c|}{\Algo{XMLC}} & \multicolumn{2}{|c|}{\Algo{Word embeddings}} & & \multicolumn{2}{|c|}{\Algo{XMLC}} & \multicolumn{2}{|c}{\Algo{Word embeddings}} \\
	& \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & % \\ \midrule
        & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c}{\Algo{PLT}} \\ \midrule
	Yahoo! & \data{68.40}{57.56}{45.84} & \databf{72.09}{61.17}{48.49} & \data{67.80}{54.88}{43.78} & \databf{71.79}{58.82}{46.38} & % \\ \midrule
	RCV1 & \data{87.73}{69.98}{50.17} & \databf{90.47}{72.54}{51.84} & \data{93.94}{76.75}{53.61} & \databf{95.41}{77.49}{53.91} \\ \midrule
...
\begin{table*}[t]
\vspace{-.2cm}
        \caption{Precision@$k$ scores with $k=\{ 1,3,5\}$ of \Algo{FastXML}, \Algo{SLEEC}, \Algo{PLT}s and \Algo{XML-CNN}. The best values are in bold.}
        \label{tab:datasets-differences-table}
        \begin{center}
                \begin{footnotesize}
                        \vspace{-0.1cm}
                        \begin{tabular}{l | l@{\hskip 0pt}| r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} }
                                \toprule
& & \multicolumn{1}{|c|}{\Algo{FastXML}} & \multicolumn{1}{|c|}{\Algo{SLEEC}} & \multicolumn{1}{|c|}{\Algo{VW+PLT}} & \multicolumn{1}{|c|}{\Algo{FT+PLT}} & \multicolumn{1}{|c|}{\Algo{FT+PLT+E}} & \multicolumn{1}{|c}{\Algo{XML-CNN}} \\
                                \midrule
RCV1 & \data{P@1}{P@3}{P@5} & \data{94.62}{78.40}{54.82} & \data{95.35}{79.51}{55.06} & \data{90.47}{72.54}{51.84} & \data{95.41}{77.49}{53.91} & \data{95.77}{\textbf{90.99}}{\textbf{82.53}} & \data{\textbf{96.83}}{81.44}{56.57} \\ \midrule
Yahoo! & \data{P@1}{P@3}{P@5} & \data{71.84}{61.33}{48.12} & \data{71.80}{57.88}{47.78} & \data{72.09}{61.17}{48.49} & \data{70.06}{58.04}{46.05} & \data{\textbf{74.08}}{\textbf{69.63}}{\textbf{64.05}} & \data{71.71}{58.40}{45.62} \\ \midrule
EUR-Lex & \data{P@1}{P@3}{P@5} & \data{68.12}{57.93}{48.97} & \data{\textbf{78.21}}{64.33}{52.47} & \data{74.55}{60.60}{50.05} & \data{73.19}{57.79}{46.98} & \data{75.08}{\textbf{70.06}}{\textbf{63.38}} & \data{72.16}{57.32}{46.49} \\ \midrule
Wiki30K & \data{P@1}{P@3}{P@5} & \data{83.26}{68.74}{58.84} & \data{\textbf{85.96}}{73.13}{62.73} & \data{84.34}{72.34}{62.72} & \data{85.11}{73.12}{62.67} & \data{85.21}{\textbf{81.29}}{\textbf{75.22}} & \data{84.06}{73.96}{64.11} \\ \midrule
Amazon12K & \data{P@1}{P@3}{P@5} & \data{94.58}{78.69}{62.26} & \data{93.61}{79.13}{63.54} & \data{91.46}{76.00}{61.40} & \data{92.98}{75.75}{59.53} & \data{93.42}{\textbf{88.75}}{\textbf{80.39}} & \data{\textbf{95.13}}{79.52}{63.46} \\ \midrule
Amazon670K & \data{P@1}{P@3}{P@5} & \data{35.59}{31.87}{28.96} & \data{34.54}{30.89}{28.25} & \data{\textbf{36.85}}{\textbf{32.48}}{\textbf{29.15}}  & \data{26.18}{22.76}{20.29} & \data{25.66}{24.15}{22.73} & \data{34.06}{30.40}{27.46} \\
%Datasets & \data{P@1}{P@3}{P@5} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} \\ \midrule
                                \bottomrule
                        \end{tabular}
                \end{footnotesize}
        \end{center}
...
%
In the second experiment, we compared the performance of \Algo{PLT}s with some state-of-the-art learners, such as \Algo{FastXML}, \Algo{SLEEC}, and the convolutional neural network (\Algo{XML-CNN}) introduced in~\citep{Liu_et_al_2017} which achieves very impressive performance. % on these datasets. 
...
%Additionally, we show that making an ensemble of PLT trees, similar to FastXML, leads to a significant boost of results in terms of precision@3 and precision@5.
...
%Since \Algo{PLT}s converge faster than \Algo{HSM} on multi-label data, we run each algorithm for 1000 iterations to let \Algo{HSM} converge. 
The results confirm our theoretical results. \Algo{HSM} and \Algo{PLT}s on multi-class data match to each other (they in fact get exactly the same model). On data with conditionally independent labels, the performance of \Algo{HSM} and \Algo{PLT}s is on-par. % after $1000$ iterations. The difference in convergence speed can be explained by the fact that \Algo{HSM} updates the model by picking one positive label at once, wheres \Algo{PLT}  carries out the updates for all positive label simultaneously. 
On data with dependent labels, \Algo{PLT} outperforms \Algo{HSM}. 
%This coincide with our theoretical finding regarding the non-vanishing regret of \Algo{HSM}. 
...
\begin{table*}[ht!]
\vspace{-.2cm}
        \caption{Training and testing time (using a single thread) of \Algo{FastXML}, \Algo{SLEEC}, \Algo{PLT} and \Algo{XML-CNN} algorithms.}
        \label{tab:datasets-differences-time-table}
        \begin{center}
                \begin{footnotesize}
                        %\vspace{-0.1cm}
                        \begin{tabular}{l | l@{\hskip 0pt}| r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} || r@{\hskip 0pt} }
                                \toprule
& & \multicolumn{1}{|c|}{\Algo{FastXML}} & \multicolumn{1}{|c|}{\Algo{SLEEC}} & \multicolumn{1}{|c|}{\Algo{VW+PLT}} & \multicolumn{1}{|c|}{\Algo{FT+PLT}} & \multicolumn{1}{|c||}{\Algo{FT+PLT+ens}} & \multicolumn{1}{|c}{\Algo{XML-CNN}} \\
                                \midrule
RCV1 & \datall{train}{test} & \datarr{9m}{10m} & \datarr{15m}{29m} & \datarr{36m}{33s} & \datarr{7m}{8s} & \datarr{15m}{1m} & \datarr{39m}{2m} \\ \midrule
Yahoo! & \datall{train}{test} & \datarr{10m}{33s} & \datarr{14m}{12s} & \datarr{5m}{2s} & \datarr{2m}{2s} & \datarr{5m}{6s} & \datarr{27m}{9s} \\ \midrule
EUR-Lex & \datall{train}{test} & \datarr{13m}{55s} & \datarr{76m}{16s} & \datarr{6m}{2s} & \datarr{5m}{1s} & \datarr{12m}{9s} & \datarr{17m}{1s} \\ \midrule
Wiki30K & \datall{train}{test} & \datarr{34m}{21s} & \datarr{44m}{1s} & \datarr{37m}{41s} & \datarr{11m}{3s} & \datarr{18m}{15s} & \datarr{88m}{9s} \\ \midrule
Amazon12K & \datall{train}{test} & \datarr{466m}{17m} & \datarr{1515m}{42m} & \datarr{33m}{4m} & \datarr{31m}{25s} & \datarr{44m}{5m} & \datarr{800m}{45s} \\ \midrule
Amazon670K & \datall{train}{test} & \datarr{789m}{21m} & \datarr{1083m}{48m} & \datarr{256m}{28m} & \datarr{196m}{3m} & \datarr{281m}{9m} & \datarr{3134m}{41m} \\
