...
multi-label.  Examples of such problems are photo and video
annotation~\citep{Deng_et_al_2011} (e.g., used for image search
engines), tagging of text documents~\citep{Dekel_Shamir_2010} (e.g.,
automatic categorization of Wikipedia articles), recommendation of bid
words for online ads~\citep{Prabhu_Varma_2014}, or prediction of the
next word in a sentence~\citep{Mikolov_et_al_2013}.
%
To be more specific, let us consider a problem of tagging Wikipedia
articles. In this case, each article is an instance/example, words
appearing in the text of articles can be considered as features, and
categories to which articles are assigned as labels. By creating a
data set from the current content of Wikipedia, we very easily end up
with an enormous problem with millions of examples and features, but
also with more than one million of labels, because that many
categories are used in Wikipedia today.
...
\begin{table}[ht!]
\vspace{-.2cm}
        \caption{Precision@K scores with $K=\{ 1,3,5\}$ of \Algo{HSM} and \Algo{PLT} algorithms. }
	...
	Delicious-200K & \data{41.58}{33.24}{28.04} & \databf{45.27}{38.95}{35.59} & \data{42.17}{37.94}{35.77} & \databf{46.98}{40.99}{38.04} \\ \midrule
	WikiLSHTC-325K & \data{36.90}{22.30}{16.60} & \databf{41.63}{26.78}{20.39} & \data{41.28}{24.68}{18.08} & \databf{41.78}{24.96}{18.53} \\ \midrule
    Amazon-670K & \data{33.64}{28.58}{25.01} & \databf{36.85}{32.48}{29.15} & \data{25.04}{21.06}{18.28} & \databf{26.18}{22.76}{20.29} \\
								\bottomrule
                        \end{tabular}
						\end{adjustbox}
                \end{small}
...
In this set of experiments, we compared the performance of \Algo{HSM} and \Algo{PLT} on eight benchmark datasets using sparse representation and word embeddings. We tuned the hyper-parameters of the models by using grid search. The range of the hyper-parameters is reported in Appendix. The results are shown in Table \ref{tab:hsm_vs_plt}. \Algo{PLT} clearly outperforms \Algo{HSM} in all cases by a very significant margin on both representations of the training data. We have to mention here, in addition,  that there is not significant difference in running time of \Algo{HSM} and \Algo{PLT}, in general.


\begin{table*}[ht!]
\vspace{-.2cm}
        \caption{Precision@K scores with $K=\{ 1,3,5\}$ of \Algo{FastXML}, \Algo{SLEEC}, \Algo{PLT} and \Algo{XML-CNN} algorithms. The highest Precision@K values are in bold for every dataset.}
...
Yahoo & \data{P@1}{P@3}{P@5} & \data{}{}{} & \data{}{}{} & \data{67.80}{54.88}{43.78} & \data{70.06}{58.04}{46.05} & \data{\textbf{74.08}}{\textbf{69.63}}{\textbf{64.05}} & \data{71.71}{58.40}{45.62} \\ \midrule
...
Wiki-30K & \data{P@1}{P@3}{P@5} & \data{83.26}{68.74}{58.84} & \data{\textbf{85.96}}{73.13}{62.73} & \data{84.34}{72.34}{62.72} & \data{85.11}{73.12}{62.67} & \data{85.21}{\textbf{81.29}}{\textbf{75.22}} & \data{84.06}{73.96}{64.11} \\ \midrule
Amazon-13K & \data{P@1}{P@3}{P@5} & \data{94.58}{78.69}{62.26} & \data{93.61}{79.13}{63.54} & \data{91.46}{76.00}{61.40} & \data{92.98}{75.75}{59.53} & \data{93.42}{\textbf{88.75}}{\textbf{80.39}} & \data{\textbf{95.13}}{79.52}{63.46} \\ \midrule
Amazon-670K & \data{P@1}{P@3}{P@5} & \data{35.59}{31.87}{28.96} & \data{34.54}{30.89}{28.25} & \data{\textbf{36.85}}{\textbf{32.48}}{\textbf{29.15}}  & \data{26.18}{22.76}{20.29} & \data{25.66}{24.15}{22.73} & \data{34.06}{30.40}{27.46} \\
...
\begin{table*}[ht!]
\vspace{-.2cm}
        \caption{Training and testing time of \Algo{FastXML}, \Algo{SLEEC}, \Algo{PLT} and \Algo{XML-CNN} algorithms.}
...
Yahoo & \datall{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{5m}{2s} & \datarr{2m}{2s} & \datarr{5m}{6s} & \datarr{27m}{9s} \\ \midrule
EUR-Lex & \datall{train}{test} & \datarr{13m}{55s} & \datarr{76m}{16s} & \datarr{6m}{2s} & \datarr{5m}{1s} & \datarr{12m}{9s} & \datarr{17m}{1s} \\ \midrule
Wiki-30K & \datall{train}{test} & \datarr{34m}{21s} & \datarr{44m}{1s} & \datarr{37m}{41s} & \datarr{11m}{3s} & \datarr{18m}{15s} & \datarr{88m}{9s} \\ \midrule
Amazon-13K & \datall{train}{test} & \datarr{466m}{17m} & \datarr{1515m}{42m} & \datarr{33m}{4m} & \datarr{31m}{25s} & \datarr{44m}{5m} & \datarr{800m}{45s} \\ \midrule
Amazon-670K & \datall{train}{test} & \datarr{789m}{21m} & \datarr{1083m}{48m} & \datarr{256m}{28m} & \datarr{196m}{3m} & \datarr{281m}{9m} & \datarr{3134m}{41m} \\
