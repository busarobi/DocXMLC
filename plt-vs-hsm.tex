...
Amazon-13(12?)K & \data{P@1}{P@3}{P@5} & \data{94.58}{78.69}{62.26} & \data{93.61}{79.13}{63.54} & \data{91.46}{76.00}{61.40} & \data{92.98}{75.75}{59.53} & \data{93.42}{\textbf{88.75}}{\textbf{80.39}} & \data{\textbf{95.13}}{79.52}{63.46} \\ \midrule
Amazon-670K & \data{P@1}{P@3}{P@5} & \data{35.59}{31.87}{28.96} & \data{34.54}{30.89}{28.25} & \data{\textbf{36.85}}{\textbf{32.48}}{\textbf{29.15}}  & \data{26.18}{22.76}{20.29} & \data{25.66}{24.15}{22.73} & \data{34.06}{30.40}{27.46} \\ \midrule
...
\vspace{-.2cm}
        ...
        \begin{center}
                \begin{small}
                        ...
                        \begin{tabular}{l@{\hskip 0pt} | l@{\hskip 0pt}| r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt}  }
                                \toprule
& & \multicolumn{1}{|c|}{\Algo{FastXML}} & \multicolumn{1}{|c|}{\Algo{SLEEC}} & \multicolumn{1}{|c|}{\Algo{VW+PLT}} & \multicolumn{1}{|c|}{\Algo{FT+PLT}} & \multicolumn{1}{|c|}{\Algo{FT+PLT+ens}} & \multicolumn{1}{||c}{\Algo{CNN}} \\
                                \midrule
RCV1 & \datarr{train}{test} & \datarr{9m}{10m} & \datarr{15m}{29m} & \datarr{36m}{33s} & \datarr{7m}{8s} & \datarr{15m}{1m} & \datarr{39m}{2m} \\ \midrule
Yahoo & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{5m}{2s} & \datarr{2m}{2s} & \datarr{5m}{6s} & \datarr{27m}{0.13m} \\ \midrule
EUR-Lex & \datarr{train}{test} & \datarr{13m}{55s} & \datarr{76m}{16s} & \datarr{6m}{2s} & \datarr{5m}{1s} & \datarr{12m}{9s} & \datarr{17m}{1s} \\ \midrule
Wiki-30K & \datarr{train}{test} & \datarr{34m}{21s} & \datarr{44m}{1s} & \datarr{37m}{41s} & \datarr{11m}{3s} & \datarr{18m}{15s} & \datarr{88m}{9s} \\ \midrule
Amazon-13(12?)K & \datarr{train}{test} & \datarr{466m}{17m} & \datarr{1515m}{42m} & \datarr{33m}{4m} & \datarr{31m}{25s} & \datarr{44m}{5m} & \datarr{800m}{45s} \\ \midrule
Amazon-670K & \datarr{train}{test} & \datarr{789m}{21m} & \datarr{1083m}{48m} & \datarr{256m}{28m} & \datarr{196m}{3m} & \datarr{281m}{9m} & \datarr{3134m}{41m} \\
