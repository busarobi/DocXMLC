...
\begin{table}[]
	\centering
	\caption{Precision@1 of PLT and HSM on XMLC benchmark datasets using the standard train-test cuts.}
	\label{tab:synthetic1}
\begin{tabular}{l|rr|rr|rr}
	\toprule
	 & \multicolumn{2}{c|}{dependent}                     & \multicolumn{2}{c|}{independent}                   & \multicolumn{2}{c}{multiclass}                    \\
...
\begin{table*}[t!]
\vspace{-.2cm}
        \caption{Main characteristics of the datasets used in the experiment and Precision@K scores with $K=\{ 1,3,5\}$ for \Algo{PLT}s and \Algo{FastXML} along with their training time in  minutes. The highest Precision@K values are in bold for every dataset.}
        ...
        \begin{center}
                \begin{small}
                        ...
                        \begin{tabular}{l@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} }
                                \toprule
& \multicolumn{6}{|c|}{Main statistics of datasets} & \multicolumn{4}{|c|}{\Algo{PLT}} & \multicolumn{4}{|c}{\Algo{FastXML}} \\
\hline
& \#labels &\#features &\#test &\#train & inst./lab. & lab./inst. & P@1 & P@3 & P@5 & Time & P@1 & P@3 & P@5 & Time \\
                                \midrule
RCV1 & 2456 & 47236 & 155962 & 623847 & 1218.56 & 4.79 & 90.46 & 72.4 & 51.86 & 64 & {\bf 91.13} & {\bf 73.35} & {\bf 52.67} & 78 \\
AmazonCat & 13330 & 203882 & 306782 & 1186239 & 448.57 & 5.04 & 91.47 & 75.84 & 61.02 & 96 & {\bf 92.95} & {\bf 77.50} & {\bf 62.51} & 561 \\
Wiki10 & 30938  &  101938 & 6616 & 14146 & 8.52 & 18.64  & {\bf 84.34} & {\bf 72.34} & {\bf 62.72} & 290 & 81.71 & 66.67 & 56.70 & 16 \\
Delicious & 205443 & 782585 & 100095 & 196606 & 72.29 & 75.54 & {\bf 45.37} & {\bf 38.94} & {35.88}& 1327 & 42.81 & 38.76 & {\bf 36.34} & 458 \\
WikiLSHTC & 325056 & 1617899 & 587084 & 1778351 & 17.46 & 3.19 & 45.67 & 29.13 & 21.95 & 653 & {\bf 49.35} & {\bf 32.69} & {\bf 24.03} & 724\\
Amazon & 670091 & 135909 & 153025 & 490449 & 3.99 & 5.45 & {\bf 36.65} & {\bf 32.12} & {\bf 28.85}& 54 & 34.24 & 29.3 & 26.12 & 422\\
                                \bottomrule
                        \end{tabular}
                \end{small}
        \end{center}
