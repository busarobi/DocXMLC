...
\vspace{-.2cm}
        ...
        \begin{center}
                \begin{small}
                        \vspace{-0.1cm}
                        \begin{tabular}{l@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | r@{\hskip 0pt} | }
                                \toprule
& \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{LOM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{PLT+ens}} & \multicolumn{1}{|c|}{\Algo{CNN}} \\
                                \midrule
RCV1 & \data{93.94}{76.75}{53.61} & \data{94.46}{77.52}{53.76} & \data{95.41}{77.49}{53.91} & \data{95.77}{90.99}{82.53} & \data{96.83}{81.44}{56.57} \\ \midrule
Yahoo & \data{67.80}{54.88}{43.78} & \data{67.73}{56.27}{44.55} & \data{71.79}{58.82}{46.38} & \data{74.08}{69.63}{64.05} & \data{71.71}{58.40}{45.62} \\ \midrule
Wiki-30K & \data{83.02}{69.66}{59.50} & \data{81.44}{67.67}{57.85} & \data{85.11}{73.12}{62.67} & \data{85.21}{81.29}{75.22} & \data{82.78}{66.34}{56.23}\\ \midrule
Amazon13K & \data{90.18}{72.53}{56.20} & \data{90.37}{73.62}{57.18} & \data{92.98}{75.75}{59.53} & \data{93.42}{88.75}{80.39} & \data{95.13}{79.52}{63.46} \\ \midrule
EUR-Lex & \data{68.69}{56.52}{47.20} & \data{66.39}{54.05}{44.73} & \data{73.19}{57.79}{46.98} & \data{75.08}{70.06}{63.38} & \data{72.16}{57.32}{46.49} \\
                                \bottomrule
                        \end{tabular}
                \end{small}
        \end{center}
