...
The experimental studies presented in this section are aimed at showing advantages of the PLT appraoch. In the first set of experiments, we test PLT and HSM in situations where label dependency is present in the data. To this end, we work with synthetic data 
...
The input data was the same for PLT and HSM, and the weight initialization was also the same. As a result, the performance on multi-class data is the same for HSM and PLT, as one would expect.
...
The second part of the experiment uses benchmark datasets taken from the XMLC repository. Each dataset we used conists of textual data. We used two represenations of the input text: bag of words and word embeddigns~\citep{Mikolov}. 
...
Wiki-30K & \data{80.75}{50.49}{36.75} & \data{80.78}{50.44}{36.71} & \data{83.26}{69.14}{58.02} & \data{83.67}{79.26}{72.67} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{}\\ \midrule
                                \bottomrule
                        \end{tabular}
                \end{small}
        \end{center}
