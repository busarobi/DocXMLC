...
One possibility is to use pretrained word embeddings, like those from word2vec~\citep{word2vec} or glove~\citep{glove} obtained on large text corpuses. The document representation can be then created from these word embeddings in many ways, for example, as an average \cite{!} or as the maximum or minimum value of each element of the embeddings~\cite{!}.
...
To improve the document representation, instead of a simple aggregation over words, one can feed the embeddings of consecutive words into a more advance deep architecture, such as LSTM ~\citep{!} or the text-based convolution neural network~\cite{Yiming_Yang}. \Algo{PLT}s can be used with such architecture as the output layer. However, the speed advantage of this tree architecture might not be so visible in case of GPU-based training, as matrix multiplication can be efficiently performed on GPUs. 
...
& & \multicolumn{1}{|c|}{\Algo{FastXML}} & \multicolumn{1}{|c|}{\Algo{SLEEC}} & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{LOM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{PLT+ens}} & \multicolumn{1}{|c}{\Algo{CNN}} \\
                                \midrule
RCV1 & \data{P@1}{P@3}{P@5} & \data{94.62}{78.40}{54.82} & \data{95.35}{79.51}{55.06} & \data{93.94}{76.75}{53.61} & \data{94.46}{77.52}{53.76} & \data{95.41}{77.49}{53.91} & \data{95.77}{90.99}{82.53} & \data{96.83}{81.44}{56.57} \\ \midrule
Yahoo & \data{P@1}{P@3}{P@5} & \data{}{}{} & \data{}{}{} & \data{67.80}{54.88}{43.78} & \data{67.73}{56.27}{44.55} & \data{71.79}{58.82}{46.38} & \data{74.08}{69.63}{64.05} & \data{71.71}{58.40}{45.62} \\ \midrule
EUR-Lex & \data{P@1}{P@3}{P@5} & \data{68.12}{57.93}{48.97} & \data{78.21}{64.33}{52.47} & \data{68.69}{56.52}{47.20} & \data{66.39}{54.05}{44.73} & \data{73.19}{57.79}{46.98} & \data{75.08}{70.06}{63.38} & \data{72.16}{57.32}{46.49} \\ \midrule
Wiki-30K & \data{P@1}{P@3}{P@5} & \data{83.26}{68.74}{58.84} & \data{85.96}{73.13}{62.73} & \data{83.02}{69.66}{59.50} & \data{81.44}{67.67}{57.85} & \data{85.11}{73.12}{62.67} & \data{85.21}{81.29}{75.22} & \data{82.78}{66.34}{56.23}\\ \midrule
Amazon-13(12?)K & \data{P@1}{P@3}{P@5} & \data{94.58}{78.69}{62.26} & \data{93.61}{79.13}{63.54} & \data{90.18}{72.53}{56.20} & \data{90.37}{73.62}{57.18} & \data{92.98}{75.75}{59.53} & \data{93.42}{88.75}{80.39} & \data{95.13}{79.52}{63.46} \\ \midrule
Amazon-670K & \data{P@1}{P@3}{P@5} & \data{35.59}{31.87}{28.96} & \data{34.54}{30.89}{28.25} & \data{25.04}{21.06}{18.28} & \data{25.67}{20.96}{18.72} & \data{26.18}{22.76}{20.29} & \data{25.66}{24.15}{22.73} & \data{?}{?}{?} \\ \midrule
Delicious-200K & \data{P@1}{P@3}{P@5} & \data{43.07}{38.66}{36.19} & \data{47.85}{42.21}{39.43} & \data{42.17}{37.94}{35.77} & \data{42.68}{38.24}{35.87} & \data{46.98}{40.99}{38.04} & \data{47.27}{44.80}{42.28} & \data{-}{-}{-} \\ \midrule
WikiLSHTC-325K & \data{P@1}{P@3}{P@5} & \data{49.75}{33.10}{24.45} & \data{54.83}{33.42}{23.85} & \data{41.28}{24.68}{18.08} & \data{50.16}{31.95}{23.59} & \data{41.78}{24.963}{18.529} & \data{40.92}{34.19}{27.35} & \data{-}{-}{-} \\
...
& & \multicolumn{1}{|c|}{\Algo{FastXML}} & \multicolumn{1}{|c|}{\Algo{SLEEC}} & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{LOM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{PLT+ens}} & \multicolumn{1}{|c}{\Algo{CNN}} \\
                                \midrule
RCV1 & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
Yahoo & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
EUR-Lex & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
Wiki-30K & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
Amazon-13(12?)K & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
Amazon-670K & \datarr{train}{test} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} & \datarr{}{} \\ \midrule
...
We also compare the performance of \Algo{PLT} with some state-of-the-art learners on benchmark dataset. As a baseline, we used Convolutional Neural Net work (CNN) models by~\citep{YimingYang} which deep network architecture achieves very impressive  performance on these datasets.
