...
The results are shown in Table \ref{tab:synthetic1}. The input data was the same for \Algo{PLT} and \Algo{HSM} in each random repetition, and in addition, the weights of learners were initialized by the same random values for a fair comparison. Consequently, the performance of \Algo{HSM} and \Algo{PLT} on multi-class data match to each other, as one would expect that. On data with independent labels, the performance of \Algo{HSM} and \Algo{PLT} is on-par after $1000$ iteration. The difference in convergence speed can be explained by the fact that \Algo{HSM} updates the model by picking one positive label at once, wheres \Algo{PLT}  carries out the update for each positive label simultaneously. On data with dependent label, \Algo{PLT} outperforms \Algo{HSM}. This coincide with our theoretical finding regarding the non-vanishing regret of \Algo{HSM}. 



\subsection{Benchmark data}

We also carried out experiments on commonly used benchmark datasets taken from XMLC repository~\footnote{http://manikvarma.org/downloads/XC/XMLRepository.html} and Yahoo news multi-label corpus~\footnote{https://yahooresearch.tumblr.com/post/164789421126/introducing-the-yahoo-news-ranked-multi-label}. Each dataset we used consists of text data, so we decided to use two representations of them: the feature vectors taken from XMLC repository and word embeddings as it is implemented in fastText~\citep{Mikolov}. 
...
\vspace{-.2cm}
        ...
        \begin{center}
                \begin{small}
                        \vspace{-0.1cm}
                        \begin{tabular}{l@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} | }
                                \toprule
	...
	Amazon12k & \data{86.20}{71.54}{57.47} & \data{91.46}{76.00}{61.40} & \data{90.18}{72.53}{56.20} & \data{92.98}{75.75}{59.53} \\ \midrule
	EUR-Lex & \data{}{}{} & \data{74.55}{60.60}{50.05} &\data{66.39}{54.05}{44.73} & \data{73.19}{57.79}{46.98} \\ \midrule
	Wiki-LSHTC & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} \\ \midrule
                                \bottomrule
                        \end{tabular}
                \end{small}
        \end{center}
...
First, we compared the performance of \Algo{HSM} and \Algo{PLT}. We tuned the hyper-parameters of the models by using grid search. The range of the hyper-parameters is reported in Appendix. The results are shown in Table \ref{tab:hsm_vs_plt}. \Algo{PLT} clearly outperforms hierarchical soft-max in all cases by a very significant margin. 


\begin{table*}[ht!]
\vspace{-.2cm}
        \caption{Precision@K scores with $K=\{ 1,3,5\}$ of \Algo{HSM}, \Algo{LOM} and \Algo{PLT} lgorithms. The highest Precision@K values are in bold for every dataset.}
        \label{tab:datasets-differences-table}
        \begin{center}
                \begin{small}
                        \vspace{-0.1cm}
                        \begin{tabular}{l@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} | r@{\hskip 4pt} r@{\hskip 4pt} r@{\hskip 4pt} | r@{\hskip 4pt} | r@{\hskip 4pt} | r@{\hskip 4pt} }
                                \toprule
& \multicolumn{4}{|c|}{\Algo{Bag of words}} & \multicolumn{5}{|c|}{\Algo{Word embeddings}} \\
\hline
& \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{LOM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{PLT+ens}} & \multicolumn{1}{|c|}{\Algo{HSM}} & \multicolumn{1}{|c|}{\Algo{LOM}} & \multicolumn{1}{|c|}{\Algo{PLT}} & \multicolumn{1}{|c|}{\Algo{PLT+ens}} & \multicolumn{1}{|c|}{\Algo{CNN}} \\
                                \midrule
RCV1 & \data{}{}{} & \data{}{}{} &\data{87.52}{70.11}{50.44} & \data{88.52}{79.99}{72.74} & \data{93.94}{76.75}{53.61} & \data{94.46}{77.52}{53.76} & \data{95.41}{77.49}{53.91} & \data{95.77}{90.99}{82.53} & \data{96.83}{}{} \\ \midrule
Yahoo & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{}{}{} & \data{67.80}{54.88}{43.78} & \data{67.73}{56.27}{44.55} & \data{71.79}{58.82}{46.38} & \data{74.08}{69.63}{64.05} & \data{71.71}{}{} \\ \midrule
Wiki-30K & \data{80.75}{50.49}{36.75} & \data{80.78}{50.44}{36.71} & \data{83.26}{69.14}{58.02} & \data{83.67}{79.26}{72.67} & \data{83.02}{69.66}{59.50} & \data{81.44}{67.67}{57.85} & \data{85.11}{73.12}{62.67} & \data{85.21}{81.29}{75.22} & \data{0.9683}{}{}\\ \midrule
Amazon13K & \data{88.42}{72.19}{56.78} & \data{88.50}{73.35}{57.96} & \data{92.29}{75.32}{59.86} & \data{91.99}{86.31}{78.25} & \data{90.18}{72.53}{56.20} & \data{90.37}{73.62}{57.18} & \data{92.98}{75.75}{59.53} & \data{93.42}{88.75}{80.39} & \data{}{}{} & \data{}{}{} \\
                                \bottomrule
                        \end{tabular}
                \end{small}
        \end{center}
